package com.ahliislamic.tokenization;
 ...
 */
public class TokenizationIslamic extends CordovaPlugin {
    ...
    private static TokenizationIslamic instance;
    public String currentCardID;

    public TokenizationIslamic() {
        instance = this;
    }

    public static TokenizationIslamic getInstance() {
        return instance;
    }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        try {
            ...
            switch (action) {
                ...
                case "login":
                    final String token = args.getString(0).trim();
                    login(token.getBytes(StandardCharsets.UTF_8));
                    break;

                case "checkCardDigitizationState":
                    checkCardDigitizationState(args.getString(0).trim(), callback);
                    break;

                case "addDigitalCard":
                    addDigitalCard(args.getString(0).trim(), callback);
                    break;
                ...
                case "getCardData":
                    getCardData(args.getString(0).trim());
                    break;

                case "doManualPayment":
                    doManualPayment(args.getString(0).trim());
                    break;

                case "setDefultPaymentCard":
                    setDefultPaymentCard(args.getString(0).trim());
                    break;
                ...
                case "getAppPkValue":
                    ...
                    Log.i(TAG, "App PK Value for AhliIslamic : " + AppPKValue);
                    break;
                ...
                try {
                    ...
                    mD1Task.updatePushToken(token, new D1Task.Callback<Void>() {
                        ...
                        public void onSuccess(@Nullable Void ignored) {
                            ...
                            Log.i(TAG, "HMS Push UpdatePushToken Success: " + token);
                        }
    ...
    public void checkCardDigitizationState(String cardID, CallbackContext callback) {
        try {
            Log.i(TAG, "Card Digitization State for Card Id : " + cardID);
                ...
                public void onSuccess(@NonNull CardDigitizationState state) {
                    ...
                    switch (state) {
                        case NOT_DIGITIZED:
                            ...
                            Log.i(TAG, "Card Digitization State of Card Id " + cardID + " is : NOT_DIGITIZED");
                            break;
                        ...
                        case DIGITIZATION_IN_PROGRESS:
                            ...
                            Log.i(TAG, "Card Digitization State of Card Id " + cardID + " is : DIGITIZATION_IN_PROGRESS");
                            break;
                        ...
                        case DIGITIZED:
                            ...
                            Log.i(TAG, "Card Digitization State of Card Id " + cardID + " is : DIGITIZED");
                            break;
                    }
                }
