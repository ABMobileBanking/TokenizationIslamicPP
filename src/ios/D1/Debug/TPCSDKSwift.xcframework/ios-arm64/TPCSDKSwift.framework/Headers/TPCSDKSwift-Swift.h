...
/// Card auxiliary scheme
@property (nonatomic, readonly, copy) NSString * _Nullable auxiliaryScheme;
...
///
/// \param auxiliaryScheme An optional string used to specify a predefined auxiliary scheme.
///
- (nonnull instancetype)initWithScheme:(enum CardScheme)scheme encryptedPayload:(NSString * _Nonnull)encryptedPayload authorizationCode:(NSString * _Nonnull)authorizationCode certificateChain:(NSArray<NSData *> * _Nonnull)certificateChain nonce:(NSData * _Nonnull)nonce nonceSignature:(NSData * _Nonnull)nonceSignature auxiliaryScheme:(NSString * _Nullable)auxiliaryScheme OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// \param provisionDelegate See <code>TPCSDKProvisionDelegate</code>
///
+ (void)provisionFromController:(UIViewController * _Nonnull)controller primaryAccountSuffix:(NSString * _Nonnull)primaryAccountSuffix cardholderName:(NSString * _Nullable)cardholderName schemeString:(NSString * _Nonnull)schemeString encryptedPayload:(NSString * _Nonnull)encryptedPayload authorizationCode:(NSString * _Nonnull)authorizationCode productId:(NSString * _Nullable)productId primaryAccountIdentifier:(NSString * _Nullable)primaryAccountIdentifier auxiliaryScheme:(NSString * _Nullable)auxiliaryScheme provisionDelegate:(id <TPCSDKProvisionDelegate> _Nullable)provisionDelegate;
